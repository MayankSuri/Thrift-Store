...
<head>
    ...
    <title>The Indian Thrift Store | Online Shopping Site</title>
 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#watch"> <img src="images/braclet.jpg" class="img-fluid " alt="" style="border-radius:0.5rem">
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="images/tshirt.jpg" class="img-fluid zoom" alt="" style="border-radius:0.5rem" >
                     <div class="h5 pt-3 font-weight-bolder">
                        Over-Sized T-Shirt
                     </div>
                  </a>
